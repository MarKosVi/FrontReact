    ...
    return (
      <Container className="App container">
        <Nav className="navbar fixed-top nav-primary is-dark is-light-text">
          <Container className="text-medium"><img src={logo} className="imgSize"  alt="logo" />Covid-19 
          <span className="text-white pl-5 ml-5 pr-2"><Link to="/">Home</Link></span>
          <span className="text-white pl-4 pr-2"><Link to="/Dashboard">Mapa</Link></span>
